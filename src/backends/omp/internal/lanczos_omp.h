#ifndef MATGEN_BACKENDS_OMP_INTERNAL_LANCZOS_OMP_H
#define MATGEN_BACKENDS_OMP_INTERNAL_LANCZOS_OMP_H

/**
 * @file lanczos_omp.h
 * @brief Internal header for OpenMP-parallel Lanczos interpolation scaling
 *
...
/**
 * @brief Scale a CSR matrix using Lanczos interpolation (OpenMP backend)
 *
 * OpenMP CPU implementation of Lanczos sparse matrix scaling.
...
#endif  // MATGEN_BACKENDS_OMP_INTERNAL_LANCZOS_OMP_H
