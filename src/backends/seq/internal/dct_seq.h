#ifndef MATGEN_BACKENDS_SEQ_INTERNAL_DCT_SEQ_H
#define MATGEN_BACKENDS_SEQ_INTERNAL_DCT_SEQ_H

/**
 * @file dct_seq.h
 * @brief Internal header for sequential DCT interpolation scaling
 *
...
/**
 * @brief Scale a CSR matrix using DCT interpolation (Sequential)
 *
 * Sequential CPU implementation of DCT sparse matrix scaling.
 ...
 */
matgen_error_t matgen_scale_dct_seq(
...
#endif  // MATGEN_BACKENDS_SEQ_INTERNAL_DCT_SEQ_H
